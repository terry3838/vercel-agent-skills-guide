...
- repo: agent-skills - source: https://github.com/vercel-labs/agent-skills.git - latest synced commit: 8c56b3d4b89e - summary: A collection of skills for AI coding agents. Skills are packaged instructions and scripts that extend agent capab
